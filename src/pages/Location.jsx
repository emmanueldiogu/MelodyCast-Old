...
const Location = (props) => {
  return (
    <main className="md:col-span-11 grid grid-cols-3 gap-7 2xl:gap-10">
      <ElevatedBox className="justify-center items-center p-4 2xl:p-6 text-9xl font-bold">+</ElevatedBox>
      <ElevatedBox className="justify-between p-4 2xl:p-6" customStyle={{
        ...
        <div className="flex flex-col justify-between">
            <div>
                <p className="font-bold text-xs leading-normal text-main capitalize">current city</p>
                <h4 className=" text-[32px] leading-full">Toronto</h4>
            </div>
            <div className="border-t-2 pt-2">
                <p><span className=" border-r-2 pr-2">Sunday</span><span className="pl-2">1 May 2024</span></p>
                <p>20:00 (UTC-4)</p>
            </div>
        </div>
        <div className="flex flex-col justify-center">
            <div>
                <img src={cloud} alt="cloud" className="2xl:max-w-[107px] 2xl:py-5"/>
            </div>
            <div className=" text-end self-end">
                <p className="font-bold text-xs leading-normal capitalize">Partly Cloudy</p>
      ...
      <ElevatedBox className="justify-between p-4 2xl:p-6" customStyle={{
        ...
        <div className="flex flex-col justify-center">
            ...
            <div className=" text-end self-end">
                <p className="font-bold text-xs leading-normal capitalize">Sunny </p>
      ...
      <ElevatedBox className="justify-between p-4 2xl:p-6" customStyle={{
        ...
        <div className="flex flex-col justify-center">
            ...
            <div className=" text-end self-end">
                <p className="font-bold text-xs leading-normal capitalize">Humid Thunderstorm</p>
      ...
      <ElevatedBox className="justify-between p-4 2xl:p-6" customStyle={{
        ...
        <div className="flex flex-col justify-center">
            ...
            <div className=" text-end self-end">
                <p className="font-bold text-xs leading-normal capitalize">Heavy Rain</p>
