      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 my-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <h2 className="city font-medium text-clamp-h2 text-white flex items-center gap-1 mb-5">
            ...
            <div className="details flex items-center">
              <div className="flex flex-col pr-8 border-r border-white">
                ...
                <h4 className=" font-normal text-clamp-h4 leading-full text-main font-bebas">
